"""
ablation_position_randpos.py

Ablation study — RANDOM POSITION TRAINED generators: effect of stamp position on attack success rate.
...
Usage:
    python3 endtoend/ablation_position_randpos.py
"""
...
RESULTS_DIR    = os.path.join(ROOT, "attack_results_endtoend_randpos")
ABL_DIR        = os.path.join(RESULTS_DIR, "ablation_position_randpos")
...
def main():
    ...
    # ── SAVE RESULTS ──────────────────────────────────────────────────────────
    save_path = os.path.join(ABL_DIR, "ablation_position_randpos_results.json")
