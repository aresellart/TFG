...
def attack_one_class(target_class):
    print(f"\n{'='*55}")
    print(f"Target: {CLASSES[target_class]} | VAE-GAN random z")
    ...
    out_dir  = os.path.join(ROOT, "attack_results_gpu_vaegan_random")
...
if __name__ == "__main__":
    ...
    print("\nDone! Results in attack_results_gpu_vaegan_random/")